...
\ExperienceEntry{\textbf{Software Engineer}}{2017 Sep - Current}{\CreateKeyword{CERN} - European Organization for Nuclear Research, Geneva, Switzerland}{
    \vspace{-10pt}
    \begin{tightitemize}
        \item Large Scale HEP Data Processing with Apache Spark. From I/O to physics analytics.
        \item Heterogeneous data processing for CMS Experiment. Porting CPU workflows to run on CUDA and OpenCL enabled devices
        \item Employing High Performance Computing resources, provided by Juelich Supercomputing Center (JSC), for HEP data processing. Software distribution and configuration
    \end{tightitemize}
} \\
...
\ProgrammingEntry{\textbf{Experienced}}{C/C++/STL/Boost \textbullet{} python \textbullet{} Scala \textbullet{} Apache Spark/MapReduce \textbullet{} SQL \textbullet{} Graphlab \textbullet{} ROOT \textbullet{} git \textbullet{} \textbullet{} LaTeX \textbullet{} scikit-learn} \\
\ProgrammingEntry{\textbf{Familiar}}{Java \textbullet{} JScript \textbullet{} php \textbullet{} Elixir/Erlang \textbullet{} Pascal \textbullet{} Go}
