\documentclass[11pt, letterpaper]{deps1}
%
% Preamble
%
\usepackage{graphicx}
...
\PersonalEntry{\textbullet{} Phones}{ +41 (76) 617-6750 \textbullet{} +41 (75) 411-2874 \textbullet{} +7 (910) 748-1514}
\PersonalEntry{\textbullet{} Email}{\href{vdkhristenko1991@gmail.com}{vdkhristenko1991@gmail.com}}
\PersonalEntry{\textbullet{} Skype}{vitya.kh}
...
\ProgrammingEntry{\textbf{Familiar}}{Apache Spark/MapReduce \textbullet{} Java \textbullet{} JScript \textbullet{} php \textbullet{} Elixir/Erlang}

\Section{Professional Experience}
\ExperienceEntry{\textbf{Level-2 CMS Hadron Calorimeter Operations Deputy Coordinator}}{2015-2016}{\CreateKeyword{CERN} - European Organization for Nuclear Research, Geneva, Switzerland}{
    \vspace{-10pt}
    \begin{tightitemize}
...
\ExperienceEntry{\textbf{Level-3 CMS Hadron Calorimeter Data Quality Monitoring Group Lead}}{2014-Current}{CMS - Compact Muon Solenoid Experiment @CERN, Geneva, Switzerland}{
    \vspace{-10pt}
    \begin{tightitemize}
        ...
        \item Complete \CreateKeyword{Software Lifecycle} Support for Critical \CreateKeyword{Data-driven Quality Control Applications}
    \end{tightitemize}
} \\
\ExperienceEntry{\textbf{Graduate Research Assistant}}{2014-Current}{CMS Experiment @CERN, Geneva, Switzerland \textbullet{} The University of Iowa, Iowa City, IA, USA}{
    \vspace{-10pt}
    \begin{tightitemize}
        ...
        \item Calibration of the CMS Hadron Forward Calorimeter using Radioactive Sources
    \end{tightitemize}
} \\
\ExperienceEntry{\textbf{Graduate Teaching Assistant}}{2012-Current}{The University of Iowa, Iowa City, IA, USA}{
    ...
    \begin{tightitemize}
        ...
        \item Grading Home Assignments for graduate \& undergraduate level Courses.
    \end{tightitemize}
} \\
...
\EducationEntry{\textbf{PhD in Physics}}{2012-2017(Expected)}{The University of Iowa, Iowa City, IA, USA}{
    \vspace{-10pt}
    \begin{tightitemize}
        \item Thesis Title, ``Search for Standard Model Higgs Boson decaying via Dimuon Channel at $\sqrt{s}=13$ TeV in CMS, Calibration of Hadron Forward Calorimeter in Preparation for Run 2''
    \end{tightitemize}
} \vspace{5pt}\\
...
\EducationEntry{\textbf{Department of Cybernatics}}{2008-2009}{Moscow Engineering Physics Institute, Moscow, Russia}{} \\
\EducationEntry{\textbf{Online Education Certificates}}{2016-2016}{Coursera}{
    \vspace{-10pt}
    \begin{tightitemize}
...
\PresentationEntry{\textbullet{} ``10B NMR Powder Pattern Optimized for Distribution of the Quadrupole Parameters''}{``Borate 2011: 7th International Conference on Borate Glasses, Crystals and Melts'' Halifax, NS Canada}
...
\AthleticEntry{\textbf{Student Athlete, Coe College Varsity Men's Tennis Team}}{2009-2012}{
    \vspace{-10pt}
    \begin{tightitemize}
